        ...
        <section className="home-header">
            ...
            <div className="container">
                <div className="header-text">
                    <h1>
                        <span className="header-text-greeting"><span className="u-text-highlight">👋🏽 Hello there,</span> my name is</span>
                        <span className="header-text-name">Alex Garcia.</span>
                        <span className="header-text-title">I build <span className="u-text-highlight">infrastructure for the web.</span></span>
                    </h1>
